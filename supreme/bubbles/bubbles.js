...
function bubbleChart() {
    ...
    var categoryCenters = {
		"Tops/Sweatshirts": {x: width/5, y: height/2},
		"Bags": {x: width/3, y: height/2},
    	"T-Shirts": {x: width/2, y: height/2},
        "Bottoms": {x: 2*width/3, y: height/2}
	};

    var categoryTitleX = {
		"Tops/Sweatshirts": width/5 - (width/12),
		"Bags": width/3,
        "T-Shirts": width/2 + (width/20),
        "Bottoms": 2*width/3 + (width/12)
	};
...
//Load data
d3.csv("https://gist.githubusercontent.com/gagejustins/0787528c48daa5bc0d127275ce3c7ac5/raw/82b6c9259398ad81cefd719880eaa38e1808cbe7/premiums_by_category.csv", function(data) {
	display(data);
});
setupButtons();